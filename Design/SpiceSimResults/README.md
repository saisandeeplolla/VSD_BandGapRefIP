...
|:----------------------:|
| *Figure 1: CTAT voltage w.r.t temperature* |

| ![ctat_circuit_sim_nrdevices](../SpiceNetlists/CTAT_Circuit/ctat_circuit_sim_nrdevices.png) |
|:----------------------:|
| *Figure 2: CTAT voltage w.r.t temperature and number of parallel device* |

| ![ctat_circuit_sim_load](../SpiceNetlists/CTAT_Circuit/ctat_circuit_sim_load.png) |
|:----------------------:|
| *Figure 3: CTAT voltage w.r.t temperature and load current* |
...
|:----------------------:|
| *Figure 4: PTAT circuit* |

| ![ptat_circuit_vqp1_vra1](../SpiceNetlists/PTAT_Circuit/ptat_circuit_vqp1_vra1.png) |
|:----------------------:|
| *Figure 5: V(qp1) & V(ra1) w.r.t temperature of the PTAT circuit* |
...
|:----------------------:|
| *Figure 6: V(ra1)-V(qp2) w.r.t temperature i.e. the PTAT voltage in the PTAT circuit* |
...
|:----------------------:|
| *Figure 7: V(qp1) & V(ra1) & V(ra1)-V(qp2) w.r.t temperature of the PTAT circuit* |

| ![ptat_circuit_id1_id2](../SpiceNetlists/PTAT_Circuit/ptat_circuit_id1_id2.png) |
|:----------------------:|
| *Figure 8: Id1 & Id2 w.r.t temperature of the PTAT circuit* |
...
[bgr_using_ideal_opamp.sp](../SpiceNetlists/BGR_using_ideal_OPAMP/bgr_using_ideal_opamp.sp)

| ![bgr_using_ideal_opamp](../SpiceNetlists/BGR_using_ideal_OPAMP/bgr_using_ideal_opamp.png) |
|:----------------------:|
| *Figure 9: BGR using ideal opamp circuit* |

| ![bgr_using_ideal_opamp_ptat](../SpiceNetlists/BGR_using_ideal_OPAMP/bgr_using_ideal_opamp_ptat.png) |
|:----------------------:|
| *Figure 10: V(ra1)-V(qp2) w.r.t temperature i.e. the PTAT voltage in the BGR circuit* |
...
|:----------------------:|
| *Figure 11: V(qp3) w.r.t temperature i.e. the CTAT voltage in the BGR circuit* |
* The desired -ve temp coefficient, i.e., the -ve slope of the curve, can be seen again in the above figure.
